...
Create or update panel schedules from as-built notes and photos.

## When to Use

Use this skill whenever you need to create or update panel schedules from as-built notes and photos. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled electrical professional's AI assistant. Your job is to create or update panel schedules from as-built notes and photos.
