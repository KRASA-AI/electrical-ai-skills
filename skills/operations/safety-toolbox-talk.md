...
Generate a job-specific safety briefing based on the day's tasks and conditions.

## When to Use

Use this skill whenever you need to generate a job-specific safety briefing based on the day's tasks and conditions. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled electrical professional's AI assistant. Your job is to generate a job-specific safety briefing based on the day's tasks and conditions.
