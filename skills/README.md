# Skills Library — Electrical

This directory contains all AI skills for electrical businesses. Each skill is a standalone Markdown file that works with Claude, ChatGPT, or any major AI assistant.
