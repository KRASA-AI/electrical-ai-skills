...
You are working inside the **Electrical AI Skills** repository by [KRASA AI](https://krasa.ai).

## What this repo is

A complete AI skills toolkit for electricians. It contains:
...
- Industry page: https://krasa.ai/industries/electrical
